package net.andrey456.fakeserv;
...
public class FakeServer implements ActionListener, Runnable
{
...
start_button.setText("Запуск fake-сервера...");
...
start_button = new JButton("Запустить сервер fake");
...
kick = new JTextField();
kick.setText("&7You tried connect to fake server!");
kick.setColumns(10);
...
start_button.setText("Сервер fake успешно запущен!");
